...
<body>
 ...
 <div class="input-holder">
                    ...
                    <input type="text" name="contact_name" id="contact_name" class="input-" placeholder="Contactname" value="<?= htmlspecialchars($user['contactname']); ?>" required />
                </div>


 <div class="input-holder">
                    <label for="contact_title">Contact Title</label>
                    <input type="text" name="contact_title" id="contact_title" class="input-" placeholder="Contacttitle" value="<?= htmlspecialchars($user['contacttitle']); ?>" required />
                </div>
              ...
              <div class="input-holder">
                    ...
                    <input type="text" name="contact_mobile" id="contact_mobile" class="input-" placeholder="Contactmobile" value="<?= htmlspecialchars($user['contactmobile']); ?>" required />
                </div>
               
                 <div class="input-holder">
                    <label for="contact_email">Contact Email</label>
                    <input type="text" name="contact_email" id="contact_email" class="input-1" placeholder="Contactmail" value="<?= htmlspecialchars($user['contactemail']); ?>"  />
                </div>
               
                 
 <div class="input-holder">
                    <label for="note">Note</label>
                    <input type="text" name="note" id="note" class="input-1" placeholder="Note" value="<?= htmlspecialchars($user['note']); ?>"  />
                </div>
<div class="input-holder">
