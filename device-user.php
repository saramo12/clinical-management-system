...
.table-wrapper::-webkit-scrollbar-thumb:hover {
    background: #555;
            ...
            .main-table td:nth-of-type(3)::before { content: "Floor"; }
            .main-table td:nth-of-type(4)::before { content: "Department"; }
            .main-table td:nth-of-type(5)::before { content: "Department Now"; }
            .main-table td:nth-of-type(6)::before { content: "Room"; }
            .main-table td:nth-of-type(7)::before { content: "Device Name"; }
            .main-table td:nth-of-type(8)::before { content: "Accessories"; }
            .main-table td:nth-of-type(9)::before { content: "Manufacturer"; }
            .main-table td:nth-of-type(10)::before { content: "Origin"; }
            .main-table td:nth-of-type(11)::before { content: "Company"; }
            .main-table td:nth-of-type(12)::before { content: "Model"; }
            .main-table td:nth-of-type(13)::before { content: "QT"; }
            .main-table td:nth-of-type(14)::before { content: "BMD-Code"; }
            .main-table td:nth-of-type(15)::before { content: "Arrival Date"; }
            .main-table td:nth-of-type(16)::before { content: "Installation Date"; }
            .main-table td:nth-of-type(17)::before { content: "Purchasing Order Date"; }
            .main-table td:nth-of-type(18)::before { content: "Price"; }
            .main-table td:nth-of-type(19)::before { content: "Warranty Period"; }
            .main-table td:nth-of-type(20)::before { content: "Warranty Start"; }
            .main-table td:nth-of-type(21)::before { content: "Warranty End"; }
            .main-table td:nth-of-type(22)::before { content: "Company Contact"; }
            .main-table td:nth-of-type(23)::before { content: "Company Telephone"; }

            .main-table td:nth-of-type(24)::before { content: "Device Safety Test"; }
        }
    </style>
</head>
<body>
