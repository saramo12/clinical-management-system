...
<body>
    ...
    <div class="body">
        ...
        <section class="section-1">
            <h4 class="title">Edit Purchasing Order <a href="purchasing-order.php">Purchasing Order</a></h4>
            ...
            <form class="form-1" method="POST" action="app/update-user.php">
                ...
                <div class="input-holder">
                    ...
                    <input type="text" name="company_name" id="company_name" class="input-1" placeholder="Companyname" value="<?= htmlspecialchars($user['companyname']); ?>"  />
                </div>
                <div class="input-holder">
                    <label for="purchasing_order_date">purchasing order Date</label>
                    <input type="text" name="purchasing_order_date" id="purchasing_order_date" class="input-1" placeholder="purchasingorderdate" value="<?= htmlspecialchars($user['purchasingorderdate']); ?>"  />
                </div>
