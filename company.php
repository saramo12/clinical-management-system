...
<head>
    ...
    @media (max-width: 768px) {
        ...
        .main-table td:nth-of-type(8)::before {
            content: "Contact Mobile1";
        }

        .main-table td:nth-of-type(9)::before {
            content: "Contact Name2";
        }
            ...
            <div style="max-width: 400px; margin-bottom: 20px;">
                <div style="position: relative;">
                    <input type="text" id="searchInput" onkeyup="filterTable()" placeholder="Search by Name..."
                        style="width: 100%; padding: 10px 40px 10px 15px; border-radius: 8px; border: 1px solid #ccc; font-size: 15px;">
                    <i class="fa fa-search"
                        style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #666;"></i>
                </div>
            </div>
                    ...
                    <table class="main-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($user['Contact Title1'] ?? '') ?></td>
                                <td><?= htmlspecialchars($user['Contact Mobile1'] ?? '') ?></td>
                                <td><?= htmlspecialchars($user['contact_name2'] ?? '') ?></td>
                                <td><?= htmlspecialchars($user['Contact Title2'] ?? '') ?></td>
                                <td><?= htmlspecialchars($user['Contact Mobile2'] ?? '') ?></td>
                                <td><?= htmlspecialchars($user['contact_name3'] ?? '') ?></td>
                                <td><?= htmlspecialchars($user['Contact Title3'] ?? '') ?></td>
                            ...
                            function filterTable() {
                                ...
                                for (i = 1; i < tr.length; i++) { // يبدأ من 1 لتخطي رأس الجدول
                                    td = tr[i].getElementsByTagName("td")[2]; // العمود رقم 25 (Hospital Code)
                                    if (td) {
