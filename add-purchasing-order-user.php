...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title">Add Purchasing Order <a href="purchasing-order-user.php">PurchasingOrder</a></h4>
			...
			<form class="form-1" method="POST" action="app/add-purchasing-order-user.php">
				<?php
					$fields = [
						"id" => "Id", "device_name" => "Device Name", "company_name" => "Company Name",
						"purchasing_order_date" => "Purchasing Order Date", "qt" => "QT", "price" => "Price"
					];
