...
.table-wrapper::-webkit-scrollbar-thumb:hover {
    background: #555;
            ...
            .main-table td:nth-of-type(12)::before { content: "Model"; }
                        ...
                        .main-table td:nth-of-type(13)::before { content: "Hospital Code"; }

            .main-table td:nth-of-type(14)::before { content: "Action"; }
        }
    </style>
</head>
<body>
                    ...
                    <tbody>
                        <?php $i = 0; foreach ($users as $user) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit-calibration.php?id=<?= $user['id'] ?>" class="btn edit-btn" title="Edit">
