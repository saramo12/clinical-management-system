...
<head>
    ...
    @media (max-width: 768px) {
        ...
        .main-table td:nth-of-type(21)::before {
            content: "Warranty Start";
        }

        .main-table td:nth-of-type(22)::before {
            content: "Warranty End";
        }
        ...
        .main-table td:nth-of-type(24)::before {
            content: "Company Telephone";
        }

        .main-table td:nth-of-type(25)::before {
            content: "Hospital Code";
        }

        .main-table td:nth-of-type(26)::before {
            content: "Device Safety Test";
        }

        .main-table td:nth-of-type(27)::before {
            content: "Action";
        }
    }
    </style>
...
<body>
        ...
        <section class="section-1">
            ...
            <div style="max-width: 400px; margin-bottom: 20px;">
                <div style="position: relative;">
                    <input type="text" id="searchInput" onkeyup="filterTable()" placeholder="Search by Hospital Code..."
    ...
    function filterTable() {
        ...
        for (i = 1; i < tr.length; i++) { // يبدأ من 1 لتخطي رأس الجدول
            td = tr[i].getElementsByTagName("td")[24]; // العمود رقم 25 (Hospital Code)
            if (td) {
