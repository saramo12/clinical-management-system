...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title">Add invoices <a href="invoices-user.php">Invoices</a></h4>
			...
			<form class="form-1" method="POST" action="app/add-invoices.php">
				<?php
					$fields = [
						"id" => "Id", "company_name" => "Company Name", "invoice_date" => "Invoice Date",
						"invoice_id" => "Invoice Id", "device_serial" => "Device Serial", "device_name" => "Device Name",
"qt" => "QT","Price" => "Price"
					];
