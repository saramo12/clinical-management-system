...
<head>
    ...
    .bg-gradient-8 {
        background: linear-gradient(90deg, rgb(35, 114, 89), #185a9d);
    }

    .bg-gradient-green {
        background: linear-gradient(90deg, rgb(114, 168, 88), #a8e063);
    }
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="hospital_link"
                                            name="hospital_link" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" id="hospital_image"
                                            name="hospital_image" accept="image/*" />
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" name="add_hospital" class="btn btn-primary">Add
                                        Hospital</button>
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="card position-relative <?= htmlspecialchars($hospital['bg']) ?>">
                            ...
                            <form method="post" class="position-absolute top-0 end-0 m-2"
                                onsubmit="return confirm('هل أنت متأكد من حذف هذا المستشفى؟');">
                                <input type="hidden" name="delete_hospital" value="<?= $index ?>" />
                                <button type="submit" class="btn btn-sm btn-danger"
                                    title="Delete Hospital">&times;</button>
                            </form>
                            <?php endif; ?>

                            <a href="<?= htmlspecialchars($hospital['link']) ?>"
                                style="text-decoration:none; color:#fff;">
                                <?php if (!empty($hospital['image'])): ?>
                                <img src="<?= htmlspecialchars($hospital['image']) ?>"
                                    alt="<?= htmlspecialchars($hospital['label']) ?>" class="card-img-top" />
                                <?php else: ?>
